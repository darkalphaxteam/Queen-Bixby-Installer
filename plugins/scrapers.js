...
if (config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'yts ?(.*)', fromMe: false, desc: Lang.SONG_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: 'yts ?(.*)', fromMe: false, desc: Lang.ISONG_DESC}, (async (message, match) => { 
        ...
        ffmpeg(stream)
            ...
            .on('end', async () => {
                ...
                await message.client.sendMessage(message.jid,Buffer.from(writer.arrayBuffer), MessageType.document, {filename: 'Queen Bixby 2022' + '.mp3', mimetype: 'audio/mpeg', quoted: message.data});
            });
    }));
